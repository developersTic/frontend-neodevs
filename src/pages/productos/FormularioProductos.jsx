      ...
      <div className=" w-full justify-center h-5/6 items-center mt-24">
        ...
        <div className="w-full">
          {/* <h1 className="font-bold text-6xl uppercase text-center w-full mx-auto"> */}
           <p className="title-shell"> Publica tus productos</p>
          {/* </h1> */}
          <form
          ...
          >
            ...
            <div className="mb-5">
              ...
              <textarea
                type="text"
                id="descripcion"
                className="block text-description placeholder-slate-400 p-2 w-full bg-slate-100 h-52"
            ...
            <input
              type="submit"
              value="Publicar"
              className="uppercase bg-sky-700 btn-publicar text-white p-2 rounded-md w-full cursor-pointer"
            />
          </form>
        </div>
      </div>
